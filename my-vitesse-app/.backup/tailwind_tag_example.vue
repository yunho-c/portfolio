...
<div>
  <div
    class="ml-4 text-xs inline-flex items-center font-bold leading-sm px-3 py-1 bg-blue-200 text-blue-700 rounded-full">
    Tag
  </div>
  ...
  <div
    class="ml-4 text-xs inline-flex items-center font-bold leading-sm px-3 py-1 bg-orange-200 text-orange-700 rounded-full">
    Linear Resonant Actuators
  </div>

  <div
    class="ml-4 text-xs inline-flex items-center font-bold leading-sm px-3 py-1 bg-red-200 text-red-700 rounded-full"
  >
...
<aside>
<div class="font-semibold">💡 Keywords:
  <p class="ml-4 text-xs inline-flex items-center font-bold leading-sm px-3 py-1 bg-blue-100 rounded-full">Bluetooth Low Energy</p>

  <div class="ml-4 text-xs inline-flex items-center font-bold leading-sm px-3 py-1 bg-green-100 rounded-full">ESP32</div>

  <div class="ml-4 text-xs inline-flex items-center font-bold leading-sm px-3 py-1 bg-orange-100 rounded-full">Linear Resonant Actuator (LRA)</div>

  <div class="ml-4 text-xs inline-flex items-center font-bold leading-sm px-3 py-1 bg-red-100 rounded-full">Ball Grid Array (BGA)</div>
